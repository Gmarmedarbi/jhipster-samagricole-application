...
describe('CategorieMySuffix Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'categorie-my-suffix', component: CategorieMySuffixComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to categorieService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCategorieMySuffixIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCategorieMySuffixIdentifier).toHaveBeenCalledWith(entity);
