...
import com.samagricole.repository.CategorieRepository;
import com.samagricole.service.dto.CategorieDTO;
import com.samagricole.service.mapper.CategorieMapper;
...
class CategorieResourceIT {
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie().code(DEFAULT_CODE).libelle(DEFAULT_LIBELLE);
        return categorie;
    }
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie().code(UPDATED_CODE).libelle(UPDATED_LIBELLE);
        return categorie;
    }
    ...
    void putExistingCategorie() throws Exception {
        ...
        updatedCategorie.code(UPDATED_CODE).libelle(UPDATED_LIBELLE);
    ...
    void partialUpdateCategorieWithPatch() throws Exception {
        ...
        partialUpdatedCategorie.code(UPDATED_CODE).libelle(UPDATED_LIBELLE);
