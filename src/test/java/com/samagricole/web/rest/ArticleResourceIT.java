package com.samagricole.web.rest;
...
import com.samagricole.IntegrationTest;
import com.samagricole.domain.Article;
import com.samagricole.repository.ArticleRepository;
import com.samagricole.service.dto.ArticleDTO;
import com.samagricole.service.mapper.ArticleMapper;
...
class ArticleResourceIT {
    ...
    private static final String DEFAULT_P_UHT = "AAAAAAAAAA";
    private static final String UPDATED_P_UHT = "BBBBBBBBBB";

    private static final Instant DEFAULT_T_VA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_T_VA = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final Long DEFAULT_P_UTTC = 1L;
    private static final Long UPDATED_P_UTTC = 2L;
    ...
    void createArticle() throws Exception {
        ...
        assertThat(testArticle.getpUHT()).isEqualTo(DEFAULT_P_UHT);
        assertThat(testArticle.gettVA()).isEqualTo(DEFAULT_T_VA);
        assertThat(testArticle.getpUTTC()).isEqualTo(DEFAULT_P_UTTC);
    }
    ...
    void getAllArticles() throws Exception {
        ...
        restArticleMockMvc
            ...
            .andExpect(jsonPath("$.[*].pUHT").value(hasItem(DEFAULT_P_UHT)))
            .andExpect(jsonPath("$.[*].tVA").value(hasItem(DEFAULT_T_VA.toString())))
            .andExpect(jsonPath("$.[*].pUTTC").value(hasItem(DEFAULT_P_UTTC.intValue())));
    }
    ...
    void getArticle() throws Exception {
        ...
        restArticleMockMvc
            ...
            .andExpect(jsonPath("$.pUHT").value(DEFAULT_P_UHT))
            .andExpect(jsonPath("$.tVA").value(DEFAULT_T_VA.toString()))
            .andExpect(jsonPath("$.pUTTC").value(DEFAULT_P_UTTC.intValue()));
    }
    ...
    void putExistingArticle() throws Exception {
        ...
        updatedArticle.code(UPDATED_CODE).libelle(UPDATED_LIBELLE).pUHT(UPDATED_P_UHT).tVA(UPDATED_T_VA).pUTTC(UPDATED_P_UTTC);
        ...
        assertThat(testArticle.getpUHT()).isEqualTo(UPDATED_P_UHT);
        assertThat(testArticle.gettVA()).isEqualTo(UPDATED_T_VA);
        assertThat(testArticle.getpUTTC()).isEqualTo(UPDATED_P_UTTC);
    }
    ...
    void partialUpdateArticleWithPatch() throws Exception {
        ...
        partialUpdatedArticle.code(UPDATED_CODE).libelle(UPDATED_LIBELLE).pUHT(UPDATED_P_UHT);
    ...
    void fullUpdateArticleWithPatch() throws Exception {
        ...
        partialUpdatedArticle.code(UPDATED_CODE).libelle(UPDATED_LIBELLE).pUHT(UPDATED_P_UHT).tVA(UPDATED_T_VA).pUTTC(UPDATED_P_UTTC);
