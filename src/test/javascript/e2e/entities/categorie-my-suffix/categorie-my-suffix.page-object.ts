...
export class CategorieComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-categorie-my-suffix div table .btn-danger'));
  title = element.all(by.css('jhi-categorie-my-suffix div h2#page-heading span')).first();
...
export class CategorieUpdatePage {
  pageTitle = element(by.id('jhi-categorie-my-suffix-heading'));
